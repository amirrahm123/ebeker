      ...
      <section style={sectionDark}>
        <div style={container} className="reveal">
          ...
          <div style={goldCalloutDark}>
            לעו״ד ערן בקר ניסיון של כ-23 שנים בהצלחה בניהול בקשות למינוי אפוטרופוס מול בית המשפט המוסמך, וכן למשרדנו ניסיון בעריכת ייפוי כוח מתמשך — מאז שאפשרות זו חוקקה בחוק.
          </div>
