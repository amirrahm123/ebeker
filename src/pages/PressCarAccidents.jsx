...
export default function PressCarAccidents() {
  ...
  return (
    <>
      <Breadcrumb items={[{ label: 'מהעיתונות', to: '#' }, { label: 'תאונות רכב' }]} />

      <section className="hero">
        <div className="hero-inner">
          <p className="hero-eyebrow">מהעיתונות</p>
          <h1>מהעיתונות<span className="accent">תאונות רכב</span></h1>
          <p className="hero-sub">כתבות ופרסומים בנושאי תאונות רכב</p>
