    ...
    <>
      ...
      <section style={sectionDark}>
        <div style={container} className="reveal">
          ...
          <p style={experienceLine}>
            לעו״ד ערן בקר ניסיון משפטי של כ-23 שנים בהצלחה בתביעות נזיקין!
          </p>
      ...
      <section style={sectionDark}>
        <div style={container} className="reveal">
          ...
          <p style={bodyDark}>
            בכל מקרה, יש לבחון בקפידה כל מקרה לגופו ולשים דגש על שאלת האחריות מכל היבטיה כסוגיה מרכזית, שכן כישלון בהוכחת הרשלנות מצד התובע יוביל לכישלון ודחייה של התביעה כולה.
          </p>
        </div>
      </section>
