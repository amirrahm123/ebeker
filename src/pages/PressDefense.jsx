...
const images = [
  { file: 'חייל מילואים שנפגע במבצע עמוד ענן הוכר כנכה צהל.webp', title: 'חייל מילואים שנפגע במבצע עמוד ענן הוכר כנכה צה"ל' },
  { file: 'קצין משטרה בכיר יוכר כנפגע של משרד הביטח.webp', title: 'קצין משטרה בכיר יוכר כנפגע של משרד הביטחון' },
  { file: 'בן 26 יוכר כנכה צהל. 2008.webp', title: 'בן 26 יוכר כנכה צה"ל' },
  { file: 'כאבי הגב של העוד הוכרו כתאונת עבודה.webp', title: 'כאבי הגב של העובד הוכרו כתאונת עבודה' },
  { file: 'ראה גופות שרופות במלחמה ומבקש שיכירו בו כנכה.webp', title: 'ראה גופות שרופות במלחמה ומבקש שיכירו בו כנכה' },
]
