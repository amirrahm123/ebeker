    ...
    <>
      ...
      <section style={sectionDark}>
        <div style={container} className="reveal">
          ...
          <div style={goldCalloutDark}>
            לעו״ד ערן בקר ניסיון משפטי של כ-23 שנים בהצלחה בתביעות ביטוח לאומי!
          </div>
      ...
      <section style={sectionLight}>
        <div style={container} className="reveal">
          ...
          <p style={bodyLight}>
            לצד פגיעות שמקורן בתאונת עבודה, ישנן פגיעות בעבודה כגון: מחלת סרטן, ירידה בשמיעה, מחלות עור, צרידות ועוד, אשר יכולות להיחשב כמחלת מקצוע. מחלת מקצוע הינה מחלה שהעובד חלה בה עקב תנאי עבודתו. בדומה לתאונת עבודה, גם מחלת מקצוע מקנה זכויות והטבות כלכליות לנפגע המוענקות על ידי המוסד לביטוח לאומי.
          </p>
          <p style={bodyLight}>
