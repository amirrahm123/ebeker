...
const lectures = [
  ...
  { type: 'image', file: 'הרצאה הלשכה בחיפה.webp', title: 'הרצאה בלשכת עורכי הדין — מחוז חיפה', desc:'מהי האסטרטגיה הנכונה בניהול תביעת נזיקין ? מה הטקטיקה הנכונה ליישום האסטרטגיה שנבחרה ?  מהי הפרקטיקה הנכונה ליישום סעיפי התקנות לקביעת דרגת נכות (קרדיולוגיה, אורתופדיה, פסיכיאטריה, נירולוגיה, פיברומיאלגיה ועוד) אלו הסוגיות המרכזיות שהעביר עו"ד בקר בהרצאתו בנושא "מורה נבוכים משפטי רפואי התקנות לקביעת נכות" במסגרת הלשכה בפני קהל של 200 עורכי דין' },
