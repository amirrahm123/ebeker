...
const cards = [
  ...
  { label: 'מעריב', url: 'https://www.maariv.co.il/breaking-news/article-1210540' },
    ...
    videos: [
      { src: '/videos/meron-channel-12-interview.mp4', label: 'ראיון ערוץ 12 — ועדת חקירה' },
  ...
  },
  {
    id: 9,
    cat: 'נזיקין · אוקטובר השחור',
    title: 'הכרה בנפגעי פוסט טראומה כנפגעי פעולת איבה',
    source: 'ועדת העבודה והרווחה',
    type: 'videoImage',
    thumbnail: '/videos/knesset-labor-committee-terror-victims.mp4',
    thumbKind: 'video',
    poster: '/pics/knesset-labor-committee-terror-victims-thumb.webp',
    description: 'חייבים לתת מענה אמיתי וראוי למעגל הנפגעים (הפוסט טראומטיים) בדרגה ראשונה של נרצחי ה-7 באוקטובר ולהכיר בהם כנפגעי פעולת איבה. דברים שנשא עו״ד ערן בקר בדיון בוועדת העבודה והרווחה שדנה בטיוטת "ההסכם למתן סיוע לנפגעי 7 באוקטובר" בין משרד האוצר למוסד לביטוח לאומי, כיו״ר פורום נזיקין וביטוח וחבר המועצה הארצית של לשכת עורכי הדין.',
    badges: ['וידאו'],
  },
  {
    id: 5,
    cat: 'נזיקין · תאונת עבודה',
  ...
  },
  {
    id: 6,
    cat: 'נזיקין · תאונת עבודה',
    title: 'מדריך גלישה לקה באירוע מוחי בים והוכר כנפגע עבודה',
    source: 'מהעיתונות',
    date: '2024',
    type: 'article',
    thumbnail: '/pics/surf-instructor-stroke-work-injury.webp',
    thumbKind: 'image',
    thumbBg: '#ffffff',
    articleImage: '/pics/surf-instructor-stroke-work-injury.webp',
    description: 'ביה"ד לעבודה קבע כי יש להכיר באירוע מוחי שנגרם למדריך גלישה כתאונת עבודה. ועדה רפואית קבעה לו נכות רפואית צמיתה בשיעור 64% המזכה אותו בקצבה חודשית. כתבה נוספת שהתפרסמה בעיתוני סופ"ש לאור הצלחתנו בניהול תביעה חריגה ומאתגרת נגד המוסד לביטוח לאומי.',
    badges: ['כתבה'],
  },
  {
    id: 3,
